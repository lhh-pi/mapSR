...
load_pretrain = torch.load("../save/_swinir_L_x2_train1/epoch-last.pth")
...
# 改进模型
new_net = mapsr.make_mapsr(scale=2)
...
torch.save(new_net, './mapsr/mapsr_x2.pth')
save_net = {'model': {'name': 'mapsr', 'args': {'scale': 2}, 'sd': model_dict}}
torch.save(save_net, './mapsr/mapsr_x2_pretrain.pth')
